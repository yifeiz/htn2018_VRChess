...
public class TestBoard : MonoBehaviour {
	...
	void Start () {
        ...
        Debug.Log("It's this color's turn: " + game.WhoseTurn);
        ...
        Debug.Log("What piece is there at A1? " + pieceAtA1.GetFenCharacter());
        ...
        Debug.Log("E2-E4 for white is valid: " + isValid);
        ...
        //Debug.Log("Special event? "+ status.Event);
        ...
        Debug.Log("How many valid moves does black have? "+ validMoves.Count());
        ...
        Debug.Log("Black has any valid moves: "+ hasValidMoves);
